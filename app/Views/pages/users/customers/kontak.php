                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="info-box card"> <i class="bi bi-geo-alt"></i>
                            <h3>Alamat</h3>
                            <p>Jl. Lkr. Luar Barat No.101,<br>Kota Jakarta Barat, DKI Jakarta.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="info-box card"> <i class="bi bi-telephone"></i>
                            <h3>Hubungi Kami</h3>
                            <p>(021) 53691015<br>(021) 80647333</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="info-box card"> <i class="bi bi-envelope"></i>
                            <h3>Email Us</h3>
                            <p>
                                <a href="speakers@highwayheroes.com" target="_blank"
                                    rel="noopener noreferrer">speakers@highwayheroes.com</a>
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6">
